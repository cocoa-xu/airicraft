...
public final class LlmDegradationVerification extends VerificationScenario {
	...
	private final BooleanSupplier degradedSpeechSeen;
	...
	private final Supplier<Boolean> resetAckSeen;
	...
	public LlmDegradationVerification(
		...
		this.degradedSpeechSeen = Objects.requireNonNull(degradedSpeechSeen, "degradedSpeechSeen");
		...
		this.resetAckSeen = Objects.requireNonNull(resetAckSeen, "resetAckSeen");
	}
	...
	protected void define(ScenarioBuilder builder) {
		builder
			...
			.assertThat("degraded speech emitted", degradedSpeechSeen)
			...
			.assertThat("reset acknowledgement spoken", resetAckSeen::get);
	}
}
