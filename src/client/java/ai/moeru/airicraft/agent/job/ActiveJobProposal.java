...
public record ActiveJobProposal(
	...
	public static ActiveJobProposal followPlayer(String targetPlayer) {
		return new ActiveJobProposal(ActiveJobType.FOLLOW_PLAYER, targetPlayer, null, null, null, null);
	}

	public static ActiveJobProposal navigateTo(GoalPosition position) {
		return new ActiveJobProposal(ActiveJobType.NAVIGATE_TO, null, position, null, null, null);
	}

	public static ActiveJobProposal mineBlocks(GoalMineSpec mineSpec) {
		return new ActiveJobProposal(ActiveJobType.MINE_BLOCKS, null, null, mineSpec, null, null);
	}

	public static ActiveJobProposal collectResource(TaskSpec taskSpec) {
		return new ActiveJobProposal(ActiveJobType.COLLECT_RESOURCE, null, null, null, taskSpec, null);
	}

	public static ActiveJobProposal askUser(String askPrompt) {
		return new ActiveJobProposal(ActiveJobType.ASK_USER, null, null, null, null, askPrompt);
	}
}
